...
<div id="woocommerce-livechat-container">
    ...
    <h1>Something went wrong with LiveChat API</h1>
    <div class="installation-desc">
        <p class="intro">
            Please <a class="a-important" href="#" onClick="window.location.reload()">try again</a> or <a href="https://secure.livechatinc.com/licence/1520/open_chat.cgi?groups=77&email=<?php echo urlencode($user_email) ?>&name=<?php echo urlencode($username) ?>&params=integration%3DWooCommerce" class="a-important" target="_blank">contact our support team</a>.<br />
            Error code: <?php echo $code ?>, details: <?php echo $message ?>.
        </p>
    </div>
    <div class="links">
